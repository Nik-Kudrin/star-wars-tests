...
/**
 * Custom JSON converter (for providing it as post action - in response body handlers)
 *
 * @param <W>
 */
    ...
    public static <W> Supplier<W> toSupplierOfType(InputStream inputStream, Class<W> targetType) {
        return () -> {
            try (InputStream stream = inputStream) {
                ...
                objectMapper.setVisibility(VisibilityChecker.Std.defaultInstance().withFieldVisibility(JsonAutoDetect.Visibility.PROTECTED_AND_PUBLIC));
